...
API routes: `app/api/{chat,embeddings,tts,health}/` · `app/api/{github,webhooks}/` · `app/api/Codex/{project-status,session-feed,session-log}/` · `app/api/cron/*` (8 jobs)
...
- Post-deploy checklist: HTTP 200, auth flow, console errors, API latency <500ms (see `~/.Codex/rules/deployment.md`)
