...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-dropdown max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-xl border bg-popover/95 p-1 text-popover-foreground shadow-lg backdrop-blur-xl',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'dark:focus:bg-[hsl(174_100%_42%/0.12)] dark:focus:text-[hsl(174_100%_55%)]',
      inset && 'pl-8',
      className
    )}
    {...props}
