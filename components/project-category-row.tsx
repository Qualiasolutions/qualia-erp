...
import { Bot, Plus, type LucideIcon } from 'lucide-react';
        ...
        <>
            <div className="space-y-4">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    bgColor,
                                    count > 0 ? 'border-transparent' : 'border-dashed border-border/50'
                                )}
                            >
                ...
                {totalCount > 0 ? (
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        >
                                            <Icon className={cn('h-5 w-5', typeConfig?.color || 'text-muted-foreground')} />
                                        </div>
                    ...
                    <div className="flex items-center justify-center rounded-xl border-2 border-dashed border-border/50 bg-muted/20 py-12">
                        <p className="text-sm text-muted-foreground">No projects yet. Click a badge above to create one.</p>
                    </div>
                )}
            </div>
