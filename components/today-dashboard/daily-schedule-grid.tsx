      ...
      <div className="relative flex h-full flex-col px-3 py-2">
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            {!isCompact && (
              <p className="mt-0.5 text-xs tabular-nums text-violet-500/40 dark:text-violet-400/35">
        ...
        {!isCompact && item.meeting?.meeting_link && (
          <a
            ...
            className="mt-auto inline-flex w-fit items-center gap-1 rounded-md bg-violet-500/85 px-2.5 py-1 text-xs font-semibold tracking-wide text-white transition-all hover:bg-violet-500 hover:shadow-sm"
    ...
    >
      ...
      <div className="absolute right-1 top-1 z-10 flex items-center gap-px rounded-md border border-border/40 bg-card/90 p-0.5 opacity-0 shadow-sm backdrop-blur-sm transition-all duration-150 group-hover/task:opacity-100">
        <button
          ...
          className="flex size-[22px] items-center justify-center rounded-[5px] text-muted-foreground/60 transition-colors hover:bg-muted/50 hover:text-foreground"
          title="Edit"
        >
          <Pencil className="size-3" />
        </button>
      ...
      <div className="flex h-full items-start gap-2 px-2.5 py-2">
        ...
        >
          {isDone ? (
            ...
            <Circle className="size-3.5 text-border/50 transition-colors hover:text-border" />
          )}
        </button>
        <div className="min-w-0 flex-1">
          <p
          ...
          {!isCompact && (
            <p className="mt-0.5 flex items-center gap-1.5 text-xs text-foreground/30">
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex shrink-0 items-center gap-2 border-b border-border/30 bg-muted/20 px-4 py-3">
        ...
        <button
          ...
          className="flex size-7 items-center justify-center rounded-lg bg-muted/30 text-muted-foreground/60 transition-colors hover:bg-muted/50 hover:text-foreground disabled:opacity-30"
        >
      ...
      {backlogTasks.length > 0 && (
        <div className="shrink-0 border-b border-border/40">
          ...
          >
            ...
            />
            <span>Backlog</span>
            <span className="rounded-full bg-muted/30 px-1.5 py-0.5 text-[10px] tabular-nums text-muted-foreground/50">
              {backlogTasks.length}
            </span>
          </button>
          {backlogOpen && (
              ...
              {backlogTasks.map((t) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="max-w-[180px] truncate text-xs text-muted-foreground transition-colors hover:text-foreground"
                  >
                    {t.title}
                  </button>
                </div>
      ...
      <div className="flex shrink-0 border-b border-border/40 bg-card/90" style={{ height: 44 }}>
        ...
        <div className="flex flex-1 items-center justify-between border-r border-dashed border-border/30 px-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-foreground">Fawzi</span>
          </div>
          <button
        ...
        <div className="flex flex-1 items-center justify-between px-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-foreground">Moayad</span>
          </div>
          <button
                ...
                >
                  <span
                    className={cn(
                      ...
                      isCurrentHour ? 'text-muted-foreground' : 'text-muted-foreground/40'
                    )}
                  >
                    {hourLabel(hour)}
                  </span>
