    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-12 items-center justify-between border-b border-white/[0.06] px-4">
        <div className="flex items-center gap-2">
          <h2 className="text-sm font-medium text-white">Today</h2>
        ...
        <div className="relative">
          ...
          {timeSlots.map((slot) => (
            <div
              key={slot.hour}
              className={cn(
                'group relative flex h-16 border-b border-white/[0.04]',
              ...
              <div className="flex w-14 shrink-0 items-start justify-end pr-3 pt-1">
                <span
                  className={cn(
                    ...
                    slot.isCurrent ? 'text-violet-400' : 'text-zinc-500'
                  )}
                >
                  {slot.label}
                </span>
                ...
                {slot.meeting ? (
                  ...
                  <div
                    className={cn(
                      ...
                      slot.isCurrent
                        ...
                        : 'border-white/[0.06] bg-zinc-800/50 hover:bg-zinc-800/80'
                    )}
                  >
                  ...
                  !slot.isPast && (
                    <button
                      ...
                      className="absolute inset-x-0 top-1 flex h-[calc(100%-8px)] items-center justify-center rounded-lg border border-dashed border-white/[0.06] text-zinc-600 opacity-0 transition-all hover:border-amber-500/30 hover:bg-amber-500/5 hover:text-amber-500 group-hover:opacity-100"
                    >
                      <Plus className="h-4 w-4" />
                    </button>
                  )
      ...
      <div className="border-t border-white/[0.06] px-4 py-2">
        <p className="text-center text-[10px] text-zinc-600">Click empty slots to add tasks</p>
      </div>
