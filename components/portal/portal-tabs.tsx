...
export function PortalTabs({ projectId }: PortalTabsProps) {
  ...
  return (
    <div className="-mx-4 border-b border-border/40 px-4 sm:mx-0 sm:px-0">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'border-transparent text-muted-foreground/60 hover:border-border/60 hover:text-foreground'
              )}
            >
              {tab.name}
            </Link>
