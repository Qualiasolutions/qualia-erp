...
export const ISSUE_STATUSES: IssueStatus[] = ["Yet to Start", "Todo", "In Progress", "Done", "Canceled"]
export const LEAD_STATUSES: LeadStatus[] = ["dropped", "cold", "hot", "active_client", "inactive_client"]
export const PROJECT_GROUPS: ProjectGroup[] = ["salman_kuwait", "tasos_kyriakides", "finished", "inactive", "active", "demos", "other"]
export const PROJECT_STATUSES: ProjectStatus[] = ["Demos", "Active", "Launched", "Delayed", "Archived", "Canceled"]
